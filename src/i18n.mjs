...
export const messages = {
  en: {
    ...
    laneName: 'Lane Spark', laneTagline: 'Directional reflex', laneHowTo: 'Tap the lane the signal points toward before time runs out.',
    ...
    laneSignal: 'Signal {lane}', laneCorrect: 'Right lane +{points}', laneWrong: 'Wrong lane', laneTimeout: 'Too late', reactionSpeed: '{value}% speed',
    ...
    orbitControlsHint: 'Tap the arena', echoControlsHint: 'Tap the tiles in order', laneControlsHint: 'Tap left, middle, or right',
    orbitArenaLabel: 'Orbit Lock game arena', echoArenaLabel: 'Echo Grid game board', laneArenaLabel: 'Lane Spark three-lane board',
    gameStatusLabel: 'Game status', finalScore: 'Final score {score}', challengeCard: 'Play {name}',
    skillTiming: 'Timing', skillMemory: 'Memory', skillReaction: 'Reaction', seconds: '~{value}s', tileLabel: 'Tile {value}',
    laneLeft: 'Left lane', laneMiddle: 'Middle lane', laneRight: 'Right lane'
  },
  ar: {
    ...
    laneName: 'ومضة المسار', laneTagline: 'سرعة الاتجاه', laneHowTo: 'المس المسار الذي تشير إليه الإشارة قبل انتهاء الوقت.',
    ...
    laneSignal: 'الإشارة {lane}', laneCorrect: 'المسار الصحيح +{points}', laneWrong: 'مسار خاطئ', laneTimeout: 'انتهى الوقت', reactionSpeed: 'سرعة {value}٪',
    ...
    orbitControlsHint: 'المس ساحة اللعب', echoControlsHint: 'المس المربعات بالترتيب', laneControlsHint: 'المس اليسار أو الوسط أو اليمين',
    orbitArenaLabel: 'ساحة لعبة قفل المدار', echoArenaLabel: 'لوحة لعبة شبكة الصدى', laneArenaLabel: 'لوحة ومضة المسار ذات ثلاثة مسارات',
    gameStatusLabel: 'حالة اللعبة', finalScore: 'النتيجة النهائية {score}', challengeCard: 'العب {name}',
    skillTiming: 'توقيت', skillMemory: 'ذاكرة', skillReaction: 'استجابة', seconds: 'نحو {value}ث', tileLabel: 'المربع {value}',
    laneLeft: 'المسار الأيسر', laneMiddle: 'المسار الأوسط', laneRight: 'المسار الأيمن'
  },
  tr: {
    ...
    laneName: 'Şerit Kıvılcımı', laneTagline: 'Yön refleksi', laneHowTo: 'Süre dolmadan sinyalin gösterdiği şeride dokun.',
    ...
    laneSignal: 'Sinyal {lane}', laneCorrect: 'Doğru şerit +{points}', laneWrong: 'Yanlış şerit', laneTimeout: 'Çok geç', reactionSpeed: '%{value} hız',
    ...
    orbitControlsHint: 'Arenaya dokun', echoControlsHint: 'Karelere sırayla dokun', laneControlsHint: 'Sol, orta veya sağ şeride dokun',
    orbitArenaLabel: 'Yörünge Kilidi oyun alanı', echoArenaLabel: 'Yankı Izgarası oyun tahtası', laneArenaLabel: 'Üç şeritli Şerit Kıvılcımı tahtası',
    gameStatusLabel: 'Oyun durumu', finalScore: 'Son puan {score}', challengeCard: '{name} oyna',
    skillTiming: 'Zamanlama', skillMemory: 'Hafıza', skillReaction: 'Refleks', seconds: '~{value} sn', tileLabel: 'Kare {value}',
    laneLeft: 'Sol şerit', laneMiddle: 'Orta şerit', laneRight: 'Sağ şerit'
  }
};
