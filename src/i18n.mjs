...
export const messages = {
  en: {
    ...
    orbitControlsHint: 'Tap the arena', echoControlsHint: 'Tap the tiles in order', lumenControlsHint: 'Choose left, center, or right', mirrorControlsHint: 'Choose one of three mirror options',
    orbitArenaLabel: 'Orbit Lock game arena', echoArenaLabel: 'Echo Grid game board', lumenArenaLabel: 'Lumen Lanes game arena', mirrorArenaLabel: 'Mirror Fuse reflection puzzle',
  ...
  ar: {
    ...
    discoveryEyebrow: 'اختر مهارتك', catalogTitle: 'اختر تحديًا', catalogHint: 'أربع ألعاب سريعة ونتيجة واحدة للتجاوز.',
    ...
    orbitControlsHint: 'المس ساحة اللعب', echoControlsHint: 'المس المربعات بالترتيب', lumenControlsHint: 'اختر اليسار أو الوسط أو اليمين', mirrorControlsHint: 'اختر واحدًا من ثلاثة انعكاسات',
    orbitArenaLabel: 'ساحة لعبة قفل المدار', echoArenaLabel: 'لوحة لعبة شبكة الصدى', lumenArenaLabel: 'ساحة لعبة مسارات الوميض', mirrorArenaLabel: 'لغز انعكاس مرآة النمط',
  ...
  tr: {
    ...
    discoveryEyebrow: 'Becerini seç', catalogTitle: 'Bir mücadele seç', catalogHint: 'Dört hızlı oyun. Geçilecek tek puan.',
    ...
    orbitControlsHint: 'Arenaya dokun', echoControlsHint: 'Karelere sırayla dokun', lumenControlsHint: 'Sol, orta veya sağı seç', mirrorControlsHint: 'Üç ayna seçeneğinden birini seç',
    orbitArenaLabel: 'Yörünge Kilidi oyun alanı', echoArenaLabel: 'Yankı Izgarası oyun tahtası', lumenArenaLabel: 'Işık Şeritleri oyun alanı', mirrorArenaLabel: 'Ayna Birleştirme yansıma bulmacası',
