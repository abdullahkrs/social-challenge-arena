...
const copy = {
  en: {
    ...
    orbitRuleDirect: 'Match the marked ring', orbitRuleLane: 'Follow the valid ◇ gate', orbitRuleOpposite: 'Use the opposite ring', orbitRuleSequence: 'Recall the requested signal', orbitOppositeFrom: 'Use the opposite of {lane}', orbitMoved: '{lane}',
  ...
  ar: {
    ...
    orbitRuleDirect: 'طابق الحلقة المحددة', orbitRuleLane: 'اتبع بوابة ◇ الصحيحة', orbitRuleOpposite: 'استخدم الحلقة المقابلة', orbitRuleSequence: 'تذكّر الإشارة المطلوبة', orbitOppositeFrom: 'استخدم الحلقة المقابلة لـ {lane}', orbitMoved: '{lane}',
  ...
  tr: {
    ...
    orbitRuleDirect: 'İşaretli halkayı eşleştir', orbitRuleLane: 'Geçerli ◇ kapısını izle', orbitRuleOpposite: 'Karşı halkayı kullan', orbitRuleSequence: 'İstenen sinyali hatırla', orbitOppositeFrom: '{lane} halkasının karşısını kullan', orbitMoved: '{lane}',
